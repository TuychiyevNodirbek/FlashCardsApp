...
/** Мультиплатформенная замена android.graphics.Color.parseColor — только "#RRGGBB"/"#AARRGGBB". */
fun parseHexColor(hex: String): Color {
    val cleaned = hex.removePrefix("#")
    val colorLong = cleaned.toLong(16)
    return if (cleaned.length == 8) Color(colorLong) else Color(0xFF000000L or colorLong)
}
