...
import uz.nodirbek.flashcardsapp.shared.model.Achievements
import uz.nodirbek.flashcardsapp.shared.model.Card
import uz.nodirbek.flashcardsapp.shared.model.Deck
import uz.nodirbek.flashcardsapp.shared.model.isDueReview
import uz.nodirbek.flashcardsapp.shared.model.isNew
...
class HomeViewModel(
    ...
    fun onSessionCompleted(reviewed: Int, accuracy: Float) {
        viewModelScope.launch {
            ...
            if ("early_bird" !in unlocked && hour < 8) unlock("early_bird")
            if ("night_owl" !in unlocked && hour >= 22) unlock("night_owl")
